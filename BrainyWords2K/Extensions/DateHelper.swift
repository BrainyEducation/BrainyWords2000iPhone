...
public extension Foundation.Date {
    ...
    */
    ...
    var stepHistoryFormat: String{
        get{
            let month = self.toString(DateFormat.custom("MMM"))
            let day = self.toString(DateFormat.custom("d"))
            let suffix = self.daySuffix
            let year = self.toString(DateFormat.custom("yyyy"))
